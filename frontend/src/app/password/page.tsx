...
const formSchema = z.object({
  ...
  confirm: z.string().min(8, "Incorrect password. Please try again."),
});
        ...
        <div className="h-screen flex justify-center items-center w-1/2 ">
          <Form {...form}>
            ...
            >
              ...
              <div>
                <h1 className="font-semibold text-[24px] text-[#09090b]">Create a strong password</h1>
              ...
              />
              <Button type="submit"  style={{backgroundColor: "#18181b", width: "416px", height: "36px"}}>
                Let's Go
              </Button>
